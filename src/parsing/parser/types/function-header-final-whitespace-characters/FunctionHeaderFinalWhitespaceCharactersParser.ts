...
export class FunctionHeaderFinalWhitespaceCharactersParser implements Parser {
	private readonly functionHeaderFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode;
	...
	public constructor(
		functionHeaderFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode,
	...
	public parseWhitespace(
		...
		const newFunctionHeaderFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode =
		...
		const functionHeaderFinalWhitespaceCharactersParser =
			new FunctionHeaderFinalWhitespaceCharactersParser(
				newFunctionHeaderFinalWhitespaceCharacters,
				this.functionBody,

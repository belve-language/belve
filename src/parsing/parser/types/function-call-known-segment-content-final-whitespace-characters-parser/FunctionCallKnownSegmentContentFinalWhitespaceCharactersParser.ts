...
export class FunctionCallKnownSegmentContentFinalWhitespaceCharactersParser implements Parser {
	private readonly functionCallKnownSegmentContentFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode;
	...
	public constructor(
		functionCallKnownSegmentContentFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode,
	...
	public parseWhitespace(
		...
		const newFunctionCallKnownSegmentContentFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode =
		...
		const functionCallKnownSegmentContentFinalWhitespaceCharactersParser =
			new FunctionCallKnownSegmentContentFinalWhitespaceCharactersParser(
				newFunctionCallKnownSegmentContentFinalWhitespaceCharacters,
				this.functionCallKnownSegmentClosingBracketCharacter,
				this.functionCallKnownStartingSegmentsRestSegments,

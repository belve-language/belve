...
export class BlockContentFinalWhitespaceCharactersParser implements Parser {
	private readonly blockContentFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode;
	...
	public constructor(
		blockContentFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode,
		blockClosingBracketCharacter: ClosingCurlyBracketCharacter,
	...
	public parseWhitespace(
		...
		const newBlockContentFinalWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode =
	...
	public parseClosingCurlyBracket(character: ClosingCurlyBracketCharacter): BlockContentParser {
		const newBlockStack: readonly (readonly [
			...
			[null, this.blockContentFinalWhitespaceCharacters, this.blockClosingBracketCharacter],
			...this.blockStack,
		];

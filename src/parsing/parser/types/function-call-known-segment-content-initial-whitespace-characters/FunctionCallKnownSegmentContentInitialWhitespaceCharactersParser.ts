...
export class FunctionCallKnownSegmentContentInitialWhitespaceCharactersParser implements Parser {
	private readonly functionCallKnownSegmentContentInitialWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode;
	...
	public constructor(
		functionCallKnownSegmentContentInitialWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode,
		...
		this.functionCallKnownSegmentContentInitialWhitespaceCharacters =
	...
	public parseWhitespace(
		...
		const newFunctionCallKnownSegmentContentInitialWhitespaceCharacters: WhitespaceCharactersConcreteTreeNode =
		...
		const functionCallKnownSegmentContentInitialWhitespaceCharactersParser =
			new FunctionCallKnownSegmentContentInitialWhitespaceCharactersParser(
				newFunctionCallKnownSegmentContentInitialWhitespaceCharacters,
				this.functionCallKnownSegmentContentIdentifierCharacters,
				this.functionCallKnownSegmentContentFinalWhitespaceCharacters,
				this.functionCallKnownSegmentClosingBracketCharacter,
				this.functionCallKnownStartingSegmentsRestSegments,
